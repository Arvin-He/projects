...
class Ui_serialDlg(object):
    def setupUi(self, serialDlg):
        ...
        self.groupCountEdit.setGeometry(QtCore.QRect(530, 40, 121, 35))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.preBtn.setGeometry(QtCore.QRect(20, 30, 160, 50))
        ...
        self.nextBtn.setGeometry(QtCore.QRect(280, 30, 160, 50))
        self.nextBtn.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.nextBtn.setObjectName("nextBtn")
        self.label_6 = QtWidgets.QLabel(self.groupBox_4)
        self.label_6.setGeometry(QtCore.QRect(460, 40, 65, 30))
        self.label_6.setObjectName("label_6")
        self.label_9 = QtWidgets.QLabel(self.groupBox_4)
        self.label_9.setGeometry(QtCore.QRect(660, 40, 111, 35))
        self.label_9.setObjectName("label_9")
        self.dataPanel = QtWidgets.QLabel(self.groupBox_4)
        self.dataPanel.setGeometry(QtCore.QRect(20, 90, 421, 331))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.dataPanel.setFont(font)
        self.dataPanel.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.dataPanel.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.dataPanel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.dataPanel.setIndent(5)
        self.dataPanel.setObjectName("dataPanel")
        self.graphPanel = QtWidgets.QLabel(self.groupBox_4)
        self.graphPanel.setGeometry(QtCore.QRect(460, 90, 521, 331))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.graphPanel.setFont(font)
        self.graphPanel.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.graphPanel.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.graphPanel.setLineWidth(1)
        self.graphPanel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.graphPanel.setIndent(5)
        self.graphPanel.setObjectName("graphPanel")
    ...
    def retranslateUi(self, serialDlg):
        ...
        self.dataPanel.setText(_translate("serialDlg", "数据面板"))
        self.graphPanel.setText(_translate("serialDlg", "曲线面板"))
