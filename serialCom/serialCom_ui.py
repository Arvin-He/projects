...
class Ui_serialDlg(object):
    def setupUi(self, serialDlg):
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 541, 751))
        ...
        self.dataTable.setGeometry(QtCore.QRect(20, 270, 271, 361))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(320, 360, 131, 41))
        self.pushButton_2.setObjectName("pushButton_2")
        self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit.setGeometry(QtCore.QRect(320, 460, 100, 30))
        self.lineEdit.setObjectName("lineEdit")
        self.groupBox_2 = QtWidgets.QGroupBox(serialDlg)
        self.groupBox_2.setGeometry(QtCore.QRect(570, 10, 440, 111))
        self.groupBox_2.setObjectName("groupBox_2")
        self.openBtn = QtWidgets.QPushButton(self.groupBox_2)
        self.openBtn.setGeometry(QtCore.QRect(210, 20, 100, 30))
        self.openBtn.setObjectName("openBtn")
        self.portEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.portEdit.setGeometry(QtCore.QRect(80, 20, 120, 30))
        self.portEdit.setReadOnly(False)
        self.portEdit.setObjectName("portEdit")
        self.label_7 = QtWidgets.QLabel(self.groupBox_2)
        self.label_7.setGeometry(QtCore.QRect(10, 20, 65, 30))
        self.label_7.setObjectName("label_7")
        self.closeBtn = QtWidgets.QPushButton(self.groupBox_2)
        self.closeBtn.setGeometry(QtCore.QRect(210, 60, 100, 30))
        self.closeBtn.setObjectName("closeBtn")
        self.label_8 = QtWidgets.QLabel(self.groupBox_2)
        self.label_8.setGeometry(QtCore.QRect(10, 60, 65, 30))
        self.label_8.setObjectName("label_8")
        self.baudrateEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.baudrateEdit.setGeometry(QtCore.QRect(80, 60, 120, 30))
        ...
        self.stopReadBtn.setGeometry(QtCore.QRect(330, 60, 100, 30))
        self.stopReadBtn.setObjectName("stopReadBtn")
        self.startReadBtn = QtWidgets.QPushButton(self.groupBox_2)
        self.startReadBtn.setGeometry(QtCore.QRect(330, 20, 100, 30))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(570, 140, 441, 621))
        self.groupBox_3.setObjectName("groupBox_3")
        self.barcodeEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.barcodeEdit.setGeometry(QtCore.QRect(80, 30, 350, 30))
        self.barcodeEdit.setObjectName("barcodeEdit")
        self.label_5 = QtWidgets.QLabel(self.groupBox_3)
        self.label_5.setGeometry(QtCore.QRect(10, 30, 65, 30))
        ...
        self.textBrowser.setGeometry(QtCore.QRect(80, 80, 351, 521))
        self.textBrowser.setObjectName("textBrowser")
        self.label_6 = QtWidgets.QLabel(serialDlg)
        self.label_6.setGeometry(QtCore.QRect(340, 430, 100, 30))
    ...
    def retranslateUi(self, serialDlg):
        ...
        self.pushButton.setText(_translate("serialDlg", "查看上一组"))
        self.pushButton_2.setText(_translate("serialDlg", "查看下一组"))
        ...
        self.label_9.setText(_translate("serialDlg", "数据显示:"))
