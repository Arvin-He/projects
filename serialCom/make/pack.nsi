!define PRODUCT_NAME "valReader"
!define PRODUCT_VERSION "1.0.0"
!define PRODUCT_PUBLISHER "Arvin"
!define PRODUCT_FULL_NAME "${PRODUCT_NAME} ${PRODUCT_VERSION}"
!define OUT_DIR "."
!define OUT_FILE_NAME "MicroBit-${PRODUCT_NAME}_${PRODUCT_VERSION}.exe"
...
!define PRODUCT_UNINST_KEY  "${UNINST_KEY}\${PRODUCT_NAME} ${PRODUCT_VERSION}"
